...
function rpgloot:player/item_parts/register_part {type:"sword",weight:[6,5,4,3,2,1],name:"Sharp",properties:{events:[],modifiers:[],attributes:[{id:physical_dmg,name:sharp,source:modifier,type:mul,value:.075}]}}
