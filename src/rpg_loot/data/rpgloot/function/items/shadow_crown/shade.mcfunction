...
summon item_display ^ ^ ^ {start_interpolation:0,interpolation_duration:0,teleport_duration:1,Tags:["rpgloot.shade"],Passengers:[{id:"minecraft:armor_stand",Invulnerable:1b,Small:1b,Marker:1b,Invisible:1b,Tags:["rpgloot.shade_brain"],equipment:{mainhand:{id:"minecraft:structure_void",count:1,components:{"minecraft:item_model":"air","minecraft:enchantments":{"rpgloot:backend/items/shadow_crown_shade":1}}}}}],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[0.5f,0.5f,0.5f]},item:{id:"minecraft:tinted_glass",count:1,components:{"minecraft:item_model":"rpgloot:shade"}}}
execute as @n[type=item_display,tag=rpgloot.shade] run function rpgloot:items/shadow_crown/shade/modify
scoreboard players add @s rpgloot.shade_count 1
scoreboard players reset @s rpgloot.shade_timer
scoreboard players reset .id rpgc.temp