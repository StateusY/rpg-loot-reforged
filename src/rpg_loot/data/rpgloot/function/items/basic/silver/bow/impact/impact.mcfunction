...
execute if score @s rpgloot.silver_impact_spike_timer matches 1 on passengers run data merge entity @s {transformation:{translation:[0f,0f,5f],scale:[3f,5f,3f]}}
