...
execute if score @s rpgloot.silver_impact_spike_timer matches 1 on passengers run data merge entity @s {transformation:{translation:[0f,0f,3f],scale:[1f,1f,10f]}}
