...
execute if score @s rpgloot.titanium_bow matches 1 run execute on passengers run data merge entity @s {transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-.25f,-7.5f,0f],scale:[45f,45f,45f]}}
