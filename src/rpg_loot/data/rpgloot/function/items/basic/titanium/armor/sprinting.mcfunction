scoreboard players remove @s[gamemode=!creative,gamemode=!spectator] rpgloot.titanium_charge 3
...
summon armor_stand ~ ~.5 ~ {NoGravity:1b,Invulnerable:1b,Small:1b,Marker:1b,Invisible:1b,Tags:["rpgloot.titanium_image"],Passengers:[{id:"minecraft:item_display",item:{id:"minecraft:tinted_glass",count:1,components:{"minecraft:item_model":"air"}}}],equipment:{mainhand:{id:"minecraft:structure_void",count:1,components:{"minecraft:item_model":"air","minecraft:enchantments":{"rpgc:ttk":1}}}}}
