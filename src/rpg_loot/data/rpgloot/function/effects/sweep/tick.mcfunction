...
execute unless score @s rpgloot.effect0 matches 2.. on vehicle run data modify entity @s item.components.minecraft:item_model set value "rpgloot:effects/sweep/sweep"
