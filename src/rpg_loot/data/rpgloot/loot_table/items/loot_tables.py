...
materials = [
    ...
    },
    {
        ...
        "bow_events": '[]',
        "armor_events": '[]',
        "chestplate_events":'[{"name": "magnite_chestplate", "source": "chest", "listen": "chest_swap", "command": "function rpgloot:items/basic/magnite/armor/swap"}]',
        "leggings_events":'[{"name": "magnite_leggings", "source": "legs", "listen": "legs_swap", "command": "function rpgloot:items/basic/magnite/armor/swap"}]',
        "boots_events":'[{"name": "magnite_boots", "source": "feet", "listen": "feet_swap", "command": "function rpgloot:items/basic/magnite/armor/swap"}]',
