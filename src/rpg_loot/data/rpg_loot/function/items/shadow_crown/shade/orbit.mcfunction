...
particle smoke ~ ~ ~ 0 0 0 0.05 35 normal
$function rpgc:z_api/damage {target:"$(target)",damage:[{type:"wither",value:$(damage)}]}
playsound minecraft:entity.ghast.death player @a ~ ~ ~ 1 0
function rpg_loot:items/shadow_crown/shade/lost with entity @s data