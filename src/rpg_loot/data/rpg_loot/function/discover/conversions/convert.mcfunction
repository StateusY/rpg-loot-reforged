...
playsound minecraft:block.bell.use player @s ~ ~ ~ 50 1.5
tellraw @s {"color":"gray","hover_event":{"action":"show_text","value":[{"text":"","color":"red","obfuscated":true}]},"italic":true,"text":"The weapon's true nature reveals!"}

# replace old item with unknown template with proper stats
item replace entity @p weapon.mainhand with minecraft:air

# rarity check
execute store result score @s rpg_loot.rarity_random_value run random value 1..151

# common
execute if score @s rpg_loot.rarity_random_value matches 1..100 run function rpg_loot:discover/conversions/common_items
# uncommon
execute if score @s rpg_loot.rarity_random_value matches 101..140 run function rpg_loot:discover/conversions/uncommon_items
# rare
execute if score @s rpg_loot.rarity_random_value matches 141..150 run function rpg_loot:discover/conversions/rare_items
# legendary
execute if score @s rpg_loot.rarity_random_value matches 151 run function rpg_loot:discover/conversions/legendary_items
