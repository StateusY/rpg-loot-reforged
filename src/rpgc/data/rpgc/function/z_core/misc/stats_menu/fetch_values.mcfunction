...
execute store result storage rpgc:temp stats.regen_amount double 0.01 run function rpgc:z_api/attribute/get {id:"regen_amount"}
execute store result storage rpgc:temp stats.regen_delay double 0.01 run function rpgc:z_api/attribute/get {id:"regen_delay"}
