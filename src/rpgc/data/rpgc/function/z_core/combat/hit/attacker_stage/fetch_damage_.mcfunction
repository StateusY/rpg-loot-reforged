...
$data modify storage rpgc:temp combat.dmg prepend value {type:"$(type)",value:"null"}
execute store result storage rpgc:temp combat.dmg[0].value double 0.0001 run scoreboard players get .dmg rpgc.temp
