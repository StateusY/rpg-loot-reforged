execute unless function rpgc:isloaded run return run tellraw @a {"color":"dark_red","text":"Can Not Clean Datpack While Uninstalled"}
function rpgc:-/damage/clear_loop
scoreboard objectives remove rpgc.joined 
...
function rpgc:-/uninstall/find_queued_players

tellraw @a {"color":"green","text":"The Datapack Was Cleaned"}
