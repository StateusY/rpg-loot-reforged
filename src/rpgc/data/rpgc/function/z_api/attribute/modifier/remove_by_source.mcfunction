...
$data modify storage rpgc:temp found_modifiers append from storage rpgc:temp modifiers[{source:"$(source)"}]
$data remove storage rpgc:temp modifiers[{source:"$(source)"}]
