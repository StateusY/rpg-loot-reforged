...
function rpgc:z_api/register_mob {type:"minecraft:iron_golem",properties:{cd:20,weight:2,hp:50,attributes:[{id:physical_res,name:base,type:add,value:0.2}],name:{"color":"blue","text":"CHONK"}}}
...
function rpgc:z_api/register_mob {type:"minecraft:iron_golem",properties:{cd:1,weight:3,hp:5,nbt:{attributes:[{id:"minecraft:scale",base:0.5},{id:"minecraft:attack_speed",base:5}]},attributes:[{id:physical_dmg,name:base,type:add,value:-5}],name:{"color":"blue","text":"mini chink"}}}
