...
execute if data storage rpgc:registry temp.weight[0] run function rpgc:-/select/calculate_total_weight
...
function rpgc:-/select/random with storage rpgc:registry temp
execute if data storage rpgc:registry temp.filtered[0] run function rpgc:-/select/recurse
